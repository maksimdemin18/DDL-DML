...
1.2. Создайте учётную запись sys_temp.
```
CREATE USER 'sys_temp'@'localhost' IDENTIFIED BY 'TPass_123';
```
...
store | store_id
```
<img width="969" height="770" alt="image" src="https://github.com/user-attachments/assets/4bec8b4b-ac82-4f4b-913e-07c5e3484a69" />
